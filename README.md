<h1 align="center"> 🚀 Gradiente Texto </h1>

## ✍️ Descrição
Exemplificação de gradiente texto
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/gradient-text.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[Publicação em Codepen](https://codepen.io/cleibp/pen/gOdrZZX) 
